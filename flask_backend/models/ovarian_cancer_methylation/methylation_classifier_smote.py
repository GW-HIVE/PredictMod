...
clf = RandomForestClassifier(n_estimators=200, max_depth=50, min_samples_split=5, max_features='sqrt', random_state=2)
...
import joblib
joblib.dump(model_data, 'methylation_model_test.pkl')
