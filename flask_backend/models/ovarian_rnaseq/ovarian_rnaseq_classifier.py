...
file_path = 'combined_patient_data.xlsx'  # Replace with the actual file path
...
clf = RandomForestClassifier(n_estimators=500, max_depth=20, min_samples_split=10, max_features=0.1, random_state=1)
...
model_data = { 'model': clf, 'feature_names': feature_names }
