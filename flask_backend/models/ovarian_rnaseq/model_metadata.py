...
if __name__ == "__main__":
    ...
    data = pd.read_excel("curated_RNAseq_patient_data.xlsx", header=None)
    ...
    feature_importance = []
    for importance in zip(feature_names, classifier.feature_importances_):
        feature_importance.append((importance[0], importance[1]))
